var UrlGetFactura = 'http://localhost:80/G3_19/controller/facturas.php?op=GetFacturas';
var UrlPostFactura = 'http://localhost:80/G3_19/controller/facturas.php?op=InsertFactura';
var UrlGetUno = 'http://localhost:80/G3_19/controller/facturas.php?op=GetUno';
var UrlPutFactura = 'http://localhost:80/G3_19/controller/facturas.php?op=UpdateFactura';
var UrlDeleteFactura = 'http://localhost:80/G3_19/controller/facturas.php?op=DeleteFactura';
    ...
    var datosfacturajson = JSON.stringify(datosfactura);
     $.ajax({
        ...
        success: function(response){
            ...
            var btnactualizar = '<input type="submit" id="btn_actualizar" onclick="ActualizarFactura('+MiItems[0].ID+')"value= "Actualizar Factura" class="btn btn-primary"></imput>';
